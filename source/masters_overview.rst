...
`Graduate Handbook <http://gradhandbook.cs.luc.edu/html>`.  See the description below.

Graduate Handbook
~~~~~~~~~~~~~~~~~

Tne `Graduate Handbook <http://gradhandbook.cs.luc.edu/html>` is a separate
document which has 
...
`Graduate Handbook <http://gradhandbook.cs.luc.edu/html>`.
